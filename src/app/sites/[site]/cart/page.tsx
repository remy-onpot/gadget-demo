    ...
    <div className="min-h-screen bg-[#F8FAFC] pb-32 md:pb-12 pt-20 md:pt-28 font-sans">
                    ...
                    >
                       <div className="flex gap-3 md:gap-5 items-start">
                          ...
                          <button 
                            ...
                            className="mt-6 md:mt-8 shrink-0 text-gray-300 hover:text-[var(--primary)] transition-colors p-2 -ml-2"
                          >
                             {item.selected ? <CheckSquare className="text-[var(--primary)]" size={20} /> : <Square size={20} />}
                          </button>
                             ...
                             <div className="flex justify-between items-end mt-3 md:mt-0">
                                ...
                                <div className="flex items-center gap-3 bg-gray-50 rounded-lg p-1 border border-gray-200">
                                   <button 
                                     ...
                                     className="w-7 h-7 flex items-center justify-center bg-white border border-gray-200 rounded shadow-sm text-slate-600 disabled:opacity-50 hover:text-[var(--primary)]"
                                   ...
                                   <button 
                                     onClick={() => updateQuantity(item.uniqueId, 1)}
                                     className="w-7 h-7 flex items-center justify-center bg-white border border-gray-200 rounded shadow-sm text-slate-600 hover:text-[var(--primary)]"
                                   >
                                      <Plus size={12} />
                                   </button>
                                </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-4 pb-8 md:hidden shadow-[0_-10px_40px_rgba(0,0,0,0.1)] z-40">
         ...
         <button 
            onClick={handleCheckout}
            disabled={selectedItems.length === 0}
            className="w-full text-white py-3.5 rounded-xl font-bold text-lg flex items-center justify-center gap-2 disabled:opacity-50 active:scale-95 transition-transform"
            style={{ backgroundColor: 'var(--primary)' }}
         >
