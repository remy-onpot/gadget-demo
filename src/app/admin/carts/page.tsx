...
// 2. Define the JSON Content Structure (The Fix for 'any')
interface CartItem {
  quantity: number;
  product: {
    name: string;
...
export default function AbandonedCartsPage() {
  ...
  const generateRecoveryLink = (cart: CartRow) => {
    ...
    // Now TypeScript knows 'items[0]' has a 'product' property
    ...
    // The "Sniper" Message 🔫
    const msg = `Hi ${name} 👋, I saw you were checking out the *${firstItem}* (Total: ₵${total}) on Payless4Tech but didn't finish!\n\nDo you need help with payment? I can offer you a small discount if you complete it now.\n\nReply YES to continue!`;
